...
The `gobot-gitea` package version always mirrors the underlying `gitea` [version](#known-versions):
...
View the [gitea sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.32/src/apps/gitea/sample-project) on github.
