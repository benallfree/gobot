...
The `gobot-gocryptfs` package version always mirrors the underlying `gocryptfs` [version](#all-known-releases):
...
`gobot-gocryptfs` comes with a [bin](https://docs.npmjs.com/cli/v10/configuring-npm/package-json#bin) shortcut for CLI usage.

### `gocryptfs  [options]`

gocryptfs (https://nuetzlich.net/gocryptfs/) runner for Gobot (https://github.com/benallfree/gobot)
...
View the [gocryptfs sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.37/src/apps/gocryptfs/sample-project) on github.
