...
gobot(`mc`, { version: `2024.3.13235157` }).run([`--version`])
...
View the [Mc sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.28/src/apps/mc/sample-project) on github.
