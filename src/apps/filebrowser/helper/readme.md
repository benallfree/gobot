...
The `gobot-filebrowser` package version always mirrors the underlying `filebrowser` [version](#known-versions):
...
View the [filebrowser sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.30/src/apps/filebrowser/sample-project) on github.
