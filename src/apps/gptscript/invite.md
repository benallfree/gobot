...
- **Test & Feedback.** Please test and review as you are able. I have tagged things as alpha for now, but I will promote it to stable after a brief testing period and back-publish all 17 versions of GPTScript.
...
`gobot-gptscript` versions mirror `gptscript` versions. Gobot has indexed 17 releases of `gptscript`:
