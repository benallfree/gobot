...
dnscryptproxy (https://dnscrypt.info) runner for Gobot (https://github.com/benallfree/gobot)
...
View the [dnscrypt-proxy sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.34/src/apps/dnscryptproxy/sample-project) on github.
