...
- **Test & Feedback.** Please test and review as you are able. I have tagged things as alpha for now, but I will promote it to stable after a brief testing period and back-publish all 363 versions of syncthing.
...
`gobot-syncthing` versions mirror `syncthing` versions. Gobot has indexed 363 releases of `syncthing`:
