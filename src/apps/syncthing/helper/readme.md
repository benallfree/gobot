...
`gobot-syncthing` comes with a [bin](https://docs.npmjs.com/cli/v10/configuring-npm/package-json#bin) shortcut for CLI usage.

### `syncthing  [options]`
syncthing (https://forum.syncthing.net/) runner for Gobot (https://github.com/benallfree/gobot)
...
View the [syncthing sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.34/src/apps/syncthing/sample-project) on github.
