...
View the [syncthing sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.30/src/apps/syncthing/sample-project) on github.
...
`gobot-syncthing` versions mirror `syncthing` versions. Gobot knows about 363 releases of `syncthing`:
