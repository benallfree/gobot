...
The `gobot-prometheus` package version always mirrors the underlying `prometheus` [version](#known-versions):
...
View the [Prometheus sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.33/src/apps/prometheus/sample-project) on github.
