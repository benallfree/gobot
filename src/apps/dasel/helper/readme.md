...
The `gobot-dasel` package version always mirrors the underlying `dasel` [version](#all-known-releases):
...
`gobot-dasel` comes with a [bin](https://docs.npmjs.com/cli/v10/configuring-npm/package-json#bin) shortcut for CLI usage.

### `dasel  [options]`
dasel (https://daseldocs.tomwright.me) runner for Gobot (https://github.com/benallfree/gobot)
...
View the [dasel sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.34/src/apps/dasel/sample-project) on github.
