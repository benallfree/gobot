...
- **Test & Feedback.** Please test and review as you are able. I have tagged things as alpha for now, but I will promote it to stable after a brief testing period and back-publish all 465 versions of Minio.
...
`gobot-minio` versions mirror `minio` versions. Gobot has indexed 465 releases of `minio`:
