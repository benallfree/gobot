![Gobot](https://raw.githubusercontent.com/benallfree/gobot/v1.0.0-alpha.17/assets/gobot-banner-300x.png)
...
View the [Minio sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.17/src/apps/minio/sample-project) on github.
