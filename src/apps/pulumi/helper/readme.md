...
View the [Pulumi sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.30/src/apps/pulumi/sample-project) on github.
...
`gobot-pulumi` versions mirror `pulumi` versions. Gobot knows about 234 releases of `pulumi`:
