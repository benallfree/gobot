...
- **Test & Feedback.** Please test and review as you are able. I have tagged things as alpha for now, but I will promote it to stable after a brief testing period and back-publish all 195 versions of Weaviate.
...
`gobot-weaviate` versions mirror `weaviate` versions. Gobot has indexed 195 releases of `weaviate`:
