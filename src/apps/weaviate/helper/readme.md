...
Gobot knows about 150 releases of `weaviate`:
...
View the [Weaviate sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.17/src/apps/weaviate/sample-project) on github.
