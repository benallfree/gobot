...
`gobot-weaviate` comes with a [bin](https://docs.npmjs.com/cli/v10/configuring-npm/package-json#bin) shortcut for CLI usage.

### `weaviate  [options]`

weaviate (https://weaviate.io) runner for Gobot (https://github.com/benallfree/gobot)
...
View the [Weaviate sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.34/src/apps/weaviate/sample-project) on github.
