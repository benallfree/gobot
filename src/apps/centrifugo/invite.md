Hello, this is a courtesy message to say that support for centrifugo has been added to the [Gobot project](https://www.npmjs.com/package/gobot) 🎸

You can run the latest version of `centrifugo` anywhere npm/npx is available:

```bash
npx gobot centrifugo --help
```

The package is [https://npmjs.org/gobot-centrifugo](https://npmjs.org/gobot-centrifugo).
...
Thanks for the great project and I hope this helps make centrifugo even more popular!
