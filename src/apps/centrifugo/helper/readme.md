...
The `gobot-centrifugo` package version always mirrors the underlying `centrifugo` [version](#known-versions):
...
View the [centrifugo sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.34/src/apps/centrifugo/sample-project) on github.
