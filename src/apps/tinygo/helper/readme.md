...
The `gobot-tinygo` package version always mirrors the underlying `tinygo` [version](#known-versions):
...
View the [tinygo sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.33/src/apps/tinygo/sample-project) on github.
