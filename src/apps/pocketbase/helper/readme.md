...
const bot = await gobot(`pocketbase`, { version: `0.22.4` })
bot.run([`--version`])
...
View the [PocketBase sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.30/src/apps/pocketbase/sample-project) on github.
