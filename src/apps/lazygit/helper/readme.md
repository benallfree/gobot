![Gobot](https://raw.githubusercontent.com/benallfree/gobot/v1.0.0-alpha.30/assets/gobot-banner-300x.png)
...
View the [Lazygit sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.30/src/apps/lazygit/sample-project) on github.
...
`gobot-lazygit` versions mirror `lazygit` versions. Gobot knows about 125 releases of `lazygit`:
