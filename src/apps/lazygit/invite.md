...
- **Test & Feedback.** Please test and review as you are able. I have tagged things as alpha for now, but I will promote it to stable after a brief testing period and back-publish all 148 versions of Lazygit.
...
`gobot-lazygit` versions mirror `lazygit` versions. Gobot has indexed 148 releases of `lazygit`:
