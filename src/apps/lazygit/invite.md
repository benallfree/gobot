...
- **Test & Feedback.** Please test and review as you are able. I have tagged things as alpha for now, but I will promote it to stable after a brief testing period and back-publish all 149 versions of Lazygit.
...
`gobot-lazygit` versions mirror `lazygit` versions. Gobot has indexed 149 releases of `lazygit`:
