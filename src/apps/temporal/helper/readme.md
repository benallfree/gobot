...
The `gobot-temporal` package version always mirrors the underlying `temporal` [version](#known-versions):
...
View the [Temporal sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.33/src/apps/temporal/sample-project) on github.
