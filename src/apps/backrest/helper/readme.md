...
const bot = await gobot(`backrest`, { version: `0.14.0` })
bot.run([`--version`])
...
View the [Backrest sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.29/src/apps/backrest/sample-project) on github.
