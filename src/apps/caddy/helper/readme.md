...
View the [Caddy sample project](https://github.com/benallfree/gobot/tree/v1.0.0-alpha.30/src/apps/caddy/sample-project) on github.
...
`gobot-caddy` versions mirror `caddy` versions. Gobot knows about 87 releases of `caddy`:
