...
# Weaviate plugin for Gobot

_Install, run, and manage `weaviate` as an npm package with CLI and API interfaces._

## What is Weaviate?

![Gobot](https://raw.githubusercontent.com/benallfree/gobot/feat/plugin-placeholders/src/plugins/weaviate/logo-50x.png)

Weaviate is an open source vector database that stores both objects and vectors, allowing for combining vector search with structured filtering with the fault-tolerance and scalability of a cloud-native database, all accessible through GraphQL, REST, and various language clients.

## Quickstart

This plugin provides [Weaviate](https://weaviate.io) support to [Gobot](https://github.com/benallfree/gobot). It is built in to Gobot.
...
Or use the `gobot-weaviate` helper package to get a CLI bin alias (the main Gobot package omits specific bin aliases to avoid CLI name pollution):
...
gobot --g-debug weaviate --help

# Run a specific  version
gobot --g-version="1.24.*" weaviate --help
...
Inside your project, use the Gobot helper to add support for `weaviate`:

```bash
npx gobot init weaviate
```

The above command will find the latest version of Weaviate and modify your `package.json` as follows:
...
View the [Weaviate sample project](https://github.com/benallfree/gobot/tree/feat/plugin-placeholders/src/plugins/weaviate/sample-project) on github.
