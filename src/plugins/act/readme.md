...
# Act plugin for Gobot

_Install, run, and manage `act` as an npm package with CLI and API interfaces._

## What is Act?

![Gobot](https://raw.githubusercontent.com/benallfree/gobot/feat/plugin-placeholders/src/plugins/act/logo-50x.png)

Run your GitHub Actions locally 🚀

## Quickstart

This plugin provides [Act](https://github.com/nektos/act) support to [Gobot](https://github.com/benallfree/gobot). It is built in to Gobot.
...
Or use the `gobot-act` helper package to get a CLI bin alias (the main Gobot package omits specific bin aliases to avoid CLI name pollution):
...
gobot --g-debug act --help

# Run a specific  version
gobot --g-version="0.22.*" act --help
...
Inside your project, use the Gobot helper to add support for `act`:

```bash
npx gobot init act
```

The above command will find the latest version of Act and modify your `package.json` as follows:
...
## Notes about `Act` support

This section is empty, which means this plugin has no special notes.

## Sample project

View the [Act sample project](https://github.com/benallfree/gobot/tree/feat/plugin-placeholders/src/plugins/act/sample-project) on github.
